...
// sample rate for the system 16kHZ
...
#define I2S_MIC_LEFT_RIGHT_CLOCK GPIO_NUM_33 //LRC is ws?
#define I2S_MIC_SERIAL_DATA GPIO_NUM_36 //SD

// Analog Microphone Settings - ADC1_CHANNEL_7 is GPIO35
//#define ADC_MIC_CHANNEL ADC1_CHANNEL_7

// speaker settings
#define I2S_SPEAKER_SERIAL_CLOCK GPIO_NUM_12 //BCLK core2
#define I2S_SPEAKER_LEFT_RIGHT_CLOCK GPIO_NUM_0
#define I2S_SPEAKER_SERIAL_DATA GPIO_NUM_2

// record button// use m5core2 button
#define GPIO_BUTTON GPIO_NUM_27

// sdcard CORRECT
#define PIN_NUM_MISO GPIO_NUM_38
#define PIN_NUM_CLK GPIO_NUM_18 //sck for m5core2
